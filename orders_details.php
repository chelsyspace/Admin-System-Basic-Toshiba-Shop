...
<html>
<head>
  <title>Toshiba Appliances Ordering System : Order Details</title>
</head>
<body>
  <center>
    ...
    try {
      ...
      $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $stmt = $conn->prepare("SELECT * FROM tbl_orders_a187991_pt2, tbl_staffs_a187991_pt2,
          tbl_customers_a187991_pt2 WHERE
    ...
    Staff: <?php echo $readrow['FLD_STAFF_NAME'] ?> <br> <br>
    Customer: <?php echo $readrow['FLD_CUST_NAME'] ?> <br>
    <hr>
